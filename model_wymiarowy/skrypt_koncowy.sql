...
/* Created on:     18.05.2019 11:46:06                          */
/*==============================================================*/
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('FactFlightActivity') and o.name = 'FK_FACTFLIG_LOCALACTU_DIMDATE1')
alter table FactFlightActivity
   drop constraint FK_FACTFLIG_LOCALACTU_DIMDATE1
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('FactFlightActivity') and o.name = 'FK_FACTFLIG_LOCALACTU_DIMTIME2')
alter table FactFlightActivity
   drop constraint FK_FACTFLIG_LOCALACTU_DIMTIME2
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('FactFlightActivity') and o.name = 'FK_FACTFLIG_LOCALACTU_DIMDATE2')
alter table FactFlightActivity
   drop constraint FK_FACTFLIG_LOCALACTU_DIMDATE2
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('FactFlightActivity') and o.name = 'FK_FACTFLIG_LOCALACTU_DIMTIME1')
alter table FactFlightActivity
   drop constraint FK_FACTFLIG_LOCALACTU_DIMTIME1
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('FactFlightActivity') and o.name = 'FK_FACTFLIG_LOCALSCHE_DIMDATE2')
alter table FactFlightActivity
   drop constraint FK_FACTFLIG_LOCALSCHE_DIMDATE2
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('FactFlightActivity') and o.name = 'FK_FACTFLIG_LOCALSCHE_DIMTIME1')
alter table FactFlightActivity
   drop constraint FK_FACTFLIG_LOCALSCHE_DIMTIME1
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('FactFlightActivity') and o.name = 'FK_FACTFLIG_LOCALSCHE_DIMDATE1')
alter table FactFlightActivity
   drop constraint FK_FACTFLIG_LOCALSCHE_DIMDATE1
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('FactFlightActivity') and o.name = 'FK_FACTFLIG_LOCALSCHE_DIMTIME2')
alter table FactFlightActivity
   drop constraint FK_FACTFLIG_LOCALSCHE_DIMTIME2
go
...
if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('FactFlightActivity') and o.name = 'FK_FACTFLIG_UNIVERSAL_DIMDATE2')
alter table FactFlightActivity
   drop constraint FK_FACTFLIG_UNIVERSAL_DIMDATE2
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('FactFlightActivity') and o.name = 'FK_FACTFLIG_UNIVERSAL_DIMTIME3')
alter table FactFlightActivity
   drop constraint FK_FACTFLIG_UNIVERSAL_DIMTIME3
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('FactFlightActivity') and o.name = 'FK_FACTFLIG_UNIVERSAL_DIMDATE1')
alter table FactFlightActivity
   drop constraint FK_FACTFLIG_UNIVERSAL_DIMDATE1
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('FactFlightActivity') and o.name = 'FK_FACTFLIG_UNIVERSAL_DIMTIME2')
alter table FactFlightActivity
   drop constraint FK_FACTFLIG_UNIVERSAL_DIMTIME2
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('FactFlightActivity') and o.name = 'FK_FACTFLIG_UNIVERSAL_DIMDATE4')
alter table FactFlightActivity
   drop constraint FK_FACTFLIG_UNIVERSAL_DIMDATE4
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('FactFlightActivity') and o.name = 'FK_FACTFLIG_UNIVERSAL_DIMTIME4')
alter table FactFlightActivity
   drop constraint FK_FACTFLIG_UNIVERSAL_DIMTIME4
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('FactFlightActivity') and o.name = 'FK_FACTFLIG_UNIVERSAL_DIMDATE3')
alter table FactFlightActivity
   drop constraint FK_FACTFLIG_UNIVERSAL_DIMDATE3
go

if exists (select 1
   from sys.sysreferences r join sys.sysobjects o on (o.id = r.constid and o.type = 'F')
   where r.fkeyid = object_id('FactFlightActivity') and o.name = 'FK_FACTFLIG_UNIVERSAL_DIMTIME1')
alter table FactFlightActivity
   drop constraint FK_FACTFLIG_UNIVERSAL_DIMTIME1
go
...
alter table FactFlightActivity
   add constraint FK_FACTFLIG_LOCALACTU_DIMDATE1 foreign key (LocalActualArrivalDate)
      references DimDate (CalendarKey)
go

alter table FactFlightActivity
   add constraint FK_FACTFLIG_LOCALACTU_DIMTIME2 foreign key (LocalActualArrivalTime)
      references DimTime (DateTimeKey)
go

alter table FactFlightActivity
   add constraint FK_FACTFLIG_LOCALACTU_DIMDATE2 foreign key (LocalActualDepartureDate)
      references DimDate (CalendarKey)
go

alter table FactFlightActivity
   add constraint FK_FACTFLIG_LOCALACTU_DIMTIME1 foreign key (LocalActualDepartureTime)
      references DimTime (DateTimeKey)
go

alter table FactFlightActivity
   add constraint FK_FACTFLIG_LOCALSCHE_DIMDATE2 foreign key (LocalScheduledArrivalDate)
      references DimDate (CalendarKey)
go

alter table FactFlightActivity
   add constraint FK_FACTFLIG_LOCALSCHE_DIMTIME1 foreign key (LocalScheduledArrivalTime)
      references DimTime (DateTimeKey)
go

alter table FactFlightActivity
   add constraint FK_FACTFLIG_LOCALSCHE_DIMDATE1 foreign key (LocalScheduledDepartureDate)
      references DimDate (CalendarKey)
go

alter table FactFlightActivity
   add constraint FK_FACTFLIG_LOCALSCHE_DIMTIME2 foreign key (LocalScheduledDepartureTime)
      references DimTime (DateTimeKey)
go
...
alter table FactFlightActivity
   add constraint FK_FACTFLIG_UNIVERSAL_DIMDATE2 foreign key (UniversalActualArrivalDate)
      references DimDate (CalendarKey)
go

alter table FactFlightActivity
   add constraint FK_FACTFLIG_UNIVERSAL_DIMTIME3 foreign key (UniversalActualArrivalTime)
      references DimTime (DateTimeKey)
go

alter table FactFlightActivity
   add constraint FK_FACTFLIG_UNIVERSAL_DIMDATE1 foreign key (UniversalActualDepartureDate)
      references DimDate (CalendarKey)
go

alter table FactFlightActivity
   add constraint FK_FACTFLIG_UNIVERSAL_DIMTIME2 foreign key (UniversalActualDepartureTime)
      references DimTime (DateTimeKey)
go

alter table FactFlightActivity
   add constraint FK_FACTFLIG_UNIVERSAL_DIMDATE4 foreign key (UniversalScheduledArrivalDate)
      references DimDate (CalendarKey)
go

alter table FactFlightActivity
   add constraint FK_FACTFLIG_UNIVERSAL_DIMTIME4 foreign key (UniversalScheduledArrivalTime)
      references DimTime (DateTimeKey)
go

alter table FactFlightActivity
   add constraint FK_FACTFLIG_UNIVERSAL_DIMDATE3 foreign key (UniversalScheduledDepartureDate)
      references DimDate (CalendarKey)
go

alter table FactFlightActivity
   add constraint FK_FACTFLIG_UNIVERSAL_DIMTIME1 foreign key (UniversalScheduledDepartureTime)
      references DimTime (DateTimeKey)
go
