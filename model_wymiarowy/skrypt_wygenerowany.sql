...
/*==============================================================*/
create index Relationship_2_FK on DimCalendar (
...
alter table DimAirline
   add constraint FK_DIMAIRLI_RELATIONS_DIMAIRLI foreign key (IataAirlineCode)
      references DimAirlineIataCode (IataAirlineCode)
go

alter table DimAirlineIataCode
   add constraint FK_DIMAIRLI_RELATIONS_DIMAIRLI foreign key (AirlineId)
...
alter table DimAirport
   add constraint FK_DIMAIRPO_RELATIONS_DIMAIRPO foreign key (ArilineCityMarketId)
      references DimAirportCityMarketId (ArilineCityMarketId)
go

alter table DimAirport
   add constraint FK_DIMAIRPO_RELATIONS_DIMAIRPO foreign key (AirlineSeqId)
      references DimAirportSeqId (AirlineSeqId)
go

alter table DimAirport
   add constraint FK_DIMAIRPO_RELATIONS_DIMAIRPO foreign key (UsDotAirportCode)
      references DimAirportUsDotCode (UsDotAirportCode)
go
...
alter table DimAirport
   add constraint FK_DIMAIRPO_RELATIONS_DIMSTATE foreign key (StateCode2)
      references DimStateFips (StateCode2)
go

alter table DimAirportCityMarketId
   add constraint FK_DIMAIRPO_RELATIONS_DIMAIRPO foreign key (AirportId)
...
alter table DimCalendar
   add constraint FK_DIMCALEN_RELATIONS_DIMMONTH foreign key ()
      references DimMonth
go
...
alter table FactFlightActivity
   add constraint FK_FACTFLIG_SCHEDULED_DIMDATET foreign key (SchedArrTime)
      references DimDateTime (DateTimeKey)
go
