...
/****** Object:  UserDefinedFunction [dbo].[getUniversalScheduledArrivalDate]    Script Date: 08.06.2019 21:40:37 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [dbo].[getUniversalScheduledArrivalDate](
@Year int, 
@Month int, 
@DayOfMonth int, 
@CRSDepTime int, 
...
@CRSElapsedTime=-9999 or @CRSElapsedTime is null return -1
